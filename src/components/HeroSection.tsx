    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container relative z-10 pt-20">
        <div className="flex flex-col-reverse md:flex-row items-center gap-12 md:gap-16">
          ...
          >
            <div className="w-52 h-52 md:w-64 md:h-64 lg:w-72 lg:h-72 rounded-full overflow-hidden ring-2 ring-primary/20 ring-offset-4 ring-offset-background shadow-xl shadow-primary/10">
              <img
                src={profileImg}
                alt="Nitesh Laljani"
